...
<h1 align="center">
  <img alt="Layout" src="./github/main-image/logo/coffeedev-logo.png">
</h1>
<br/>
<h1 align="center">
  <img alt="Layout" src="./github/main-image/gif/coffeedev-video.gif">
</h1>

<h1 align="center">Repository with Frontend, Backend and Mobile of the CoffeeDev project.</h1>
...
<h1>Backend</h1>
<h3 align="center">
  Express Application for CoffeeDev project
</h3>
...
<p align="center">CoffeeDev - Exchange of ideias between developers!</p>
...
```bash
$ git clone https://github.com/Vynny/coffeedev.git && cd coffeedev
...
$ gh repo fork Vynny21/coffeedev
```
...
```bash
# Clone your fork
$ git clone your-fork-url && cd coffeedev
...
<h1>Frontend</h1>
<h3 align="center">
  ReactJS Application for CoffeeDev project
</h3>
...
<p align="center">
  <img alt="Layout" src="./github/main-image/signin/coffeedev-signin.png">
</p>
<p align="center">
  <img alt="Layout" src="./github/main-image/signup/coffeedev-signup.png">
</p>
<p align="center">
  <img alt="Layout" src="./github/main-image/reset-password/coffeedev-reset-password.png">
</p>
...
```bash
$ git clone https://github.com/Vynny21/coffeedev.git && cd coffeedev
```
...
<h3 align="center">
  React Native Application for CoffeeDev project
</h3>
...
<p align="center">
  <img alt="Layout" src="github/main-image/splashscreen/coffeedev-splashscreen.png">
</p>
...
- Have this application's [API](https://github.com/Vynny21/coffeedev_mobile) running

**Clone the project and access the folder**

```bash
$ git clone https://github.com/Vynny21/coffeedev_mobile.git && cd coffeedev_mob
OR 
$ git clone https://github.com/Vynny21/coffeedev_mobile.git
...
$ gh repo fork Vynny21/coffeedev_mobile
```
...
# Clone your fork
# 
$ git clone your-fork-url && cd coffeedev_mobile
